    ...
    return (
        <div className="relative flex flex-col items-center justify-end h-full w-full group">
            ...
            <div className="absolute -bottom-16 w-full flex justify-center items-start h-16">
                <span className="text-[8px] md:text-xs font-medium text-brand-white/60 uppercase tracking-wide text-center leading-tight -rotate-45 md:rotate-0 origin-top-left md:origin-center translate-y-2 md:translate-y-0 w-20 md:w-auto">
                    {skill.name}
                </span>
            </div>
        </div>
