    ...
    return (
        ...
        >
            ...
            <div className="sticky top-0 h-screen w-full flex items-center justify-center overflow-hidden">
                ...
                <div className="absolute top-[4.5rem] md:top-[5.5rem] left-0 right-0 text-center z-20">
                    {mounted && (
    ...
    return (
        ...
        >
            ...
            <div className="w-full md:w-[55%]">
                <div className="relative aspect-square rounded-[24px] overflow-hidden shadow-2xl bg-black">
                    {item.video ? (
                        <video
                            src={item.video}
                            autoPlay
            ...
            <div className="w-full md:w-[45%]">
                <div className="p-10 md:p-12 rounded-[28px] bg-brand-white/5 backdrop-blur-xl border border-brand-white/10">
